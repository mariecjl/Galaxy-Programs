...
#the columns for O3727 error, O4959 error, O5007 error and the HBeta error are respectively 63rd, 91st, 95th and 87th columns
column_indices = [63, 91, 95, 87]

#creating a new csv file to store the errors
errors_csv_path = "errors.csv"
with open(errors_csv_path, 'w', newline='') as errors_csv:
...
print(f"Error values written to {errors_csv_path}")
