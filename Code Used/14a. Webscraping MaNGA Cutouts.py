...
def filtertrio(directory, ifu, url, destination="collage"):
    #specifying the location of the cutouts and the corresponding content description
    for (hdu, channel, band, cutoutype) in [(4, 6, "H-alpha", "Halpha"), (1, 0, "V-band", "V"), (1, 19, "Stellar Mass Density", "Smass")]:
        img = None 
        try:
        ...
        if img is not None:
            #displaying the cutout by accessing the hdu and channel
    ...
    #if the cutouts of all three cutouts were successful:
    try:
...
def verticalpaste(cutout,collage,finalimg="collage"):
...
for i in range(0, 615):
    ...
    for ifu in ('12701', '12702', '12703', '12704', '12705', '1901', '1902', '3701', '3702', '3703', '3704', '6101', '6102', '6103', '6104', '9101', '9102'):
        ...
        if (i%3==0 and ifu=='12701'):
            ...
            filtertrio(parentdirectory,ifu,url,f"collage{directorysetter}, {int(directorysetter)+1}, {int(directorysetter)+2}.png")
            ...
            verticalpaste("cutout",f"collage{directorysetter}, {int(directorysetter)+1}, {int(directorysetter)+2}.png",f"collage{directorysetter}, {int(directorysetter)+1}, {int(directorysetter)+2}.png")
